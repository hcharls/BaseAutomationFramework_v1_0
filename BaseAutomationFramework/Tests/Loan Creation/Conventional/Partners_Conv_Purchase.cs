...
namespace BaseAutomationFramework.Tests.Encompass.LoanCreation.Conventional
{
	[TestFixture]
	public class Partners_Conv_Purchase : BaseTest
	{
		...
		public void EncompassNewLoanCreation(IDictionary<string, string> data)
		{
			...
			try
			{
				...
				//	.SelectItem_PartnersConvPurchase();
