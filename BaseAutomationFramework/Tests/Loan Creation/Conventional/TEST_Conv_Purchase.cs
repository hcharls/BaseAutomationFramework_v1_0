...
{
	[TestFixture]
	public class Conv_Purchase : BaseTest
	{
		...
		public void EncompassNewLoanCreation(IDictionary<string, string> data)
		{
			...
			try
			{
                ...
                BorrowerSummary
					...
					.chk_LoanPurpose_Check("Purchase")
				...
				VerificationOfEmployment
					...
					.txt_EmployerPhone_SendKeys(MasterData.HomePhone)
					.txt_EmployerEmail_SendKeys("test@test.com")
					.txt_BusinessName_SendKeys("test")
					.txt_BusinessPhone_SendKeys(MasterData.HomePhone)
				...
				VerificationOfDepository
					...
					.txt_DepositoryPhone_SendKeys(MasterData.HomePhone)
				...
				//ConditionsSent
				//.Open_FromLogTab()
				//.txt_RealEstateBrokerBuyerName_SendKeys("test")
				//.txt_RealEstateBrokerBuyerAddress_SendKeys("test")
				//.txt_RealEstateBrokerBuyerCity_SendKeys("Burbank")
				//.txt_RealEstateBrokerBuyerState_SendKeys("CA")
				//.txt_RealEstateBrokerBuyerZip_SendKeys("91502")
				//.txt_RealEstateBrokerBuyerLicenseID_SendKeys("132132321")
				//.txt_RealEstateBrokerBuyerContact_SendKeys("test")
				//.txt_RealEstateBrokerBuyerContactLicenseID_SendKeys("321321321")
				//.txt_RealEstateBrokerBuyerEmail_SendKeys("test@test.com")
				//.txt_RealEstateBrokerBuyerPhone_SendKeys("5645646544")
				//.txt_RealEstateBrokerSellerName_SendKeys("test")
				//.txt_RealEstateBrokerSellerZip_SendKeys("91502")
				//.txt_RealEstateBrokerSellerLicenseID_SendKeys("3213213121")
				//.txt_RealEstateBrokerSellerContact_SendKeys("test")
				//.txt_RealEstateBrokerSellerContactLicenseID_SendKeys("321321213")
				//.txt_RealEstateBrokerSellerEmail_SendKeys("test@test.com")
				//.txt_RealEstateBrokerSellerPhone_SendKeys("5645646544")
				//.txt_RealEstateBrokerSellerAddress_SendKeys("test")
				//.txt_RealEstateBrokerSellerState_SendKeys("CA")
				//.txt_RealEstateBrokerSellerCity_SendKeys("Burbank")
				//.txt_SellerAddress_SendKeys("test")
				//.txt_SellerCity_SendKeys("Burbank")
				//.txt_SellerZip_SendKeys("91502")
				//.txt_SellerState_SendKeys("CA")
				//.txt_SellerName_SendKeys("test")
