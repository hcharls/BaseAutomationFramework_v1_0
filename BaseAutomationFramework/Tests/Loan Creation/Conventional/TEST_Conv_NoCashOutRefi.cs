...
{
	[TestFixture]
	public class Conv_NoCashOutRefi : BaseTest
	{
		...
		public void EncompassNewLoanCreation(IDictionary<string, string> data)
		{
			...
			try
			{
				...
				OB_SearchResults
					.Initialize()
					.SelectLoanProgram_Click(MasterData.LoanProgram)
				...
				//PipelineView
				//	.Initialize()
				//	.Pipeline_som_SelectCurrentLoan(MasterData.LoanNumber);
