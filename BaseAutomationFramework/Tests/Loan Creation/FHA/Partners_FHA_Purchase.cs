...
namespace BaseAutomationFramework.Tests.Encompass.LoanCreation.FHA
{
	[TestFixture]
	public class Partners_FHA_Purchase : BaseTest
	{
		...
		public void EncompassNewLoanCreation(IDictionary<string, string> data)
		{
			...
			try
			{
				...
				//	.SelectItem_PartnersFHAPurchase();
				...
				//HUD92900LTFHALoanTransmittal
				//	.OpenForm_FromFormsTab()
				//	.chk_ConstructionExisting_Check(true);

				//FHAManagement
				//	.OpenForm_FromFormsTab()
				//	.tab_Tracking_Click()
				//	.txt_FHACaseNumber_SendKeys("123132123132")
				//	.txt_FHACaseNumberDate_SendKeys("11212017");
