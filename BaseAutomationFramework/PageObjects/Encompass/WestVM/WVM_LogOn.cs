...
namespace BaseAutomationFramework.PageObjects.Encompass
{
	public class WVM_LogOn : BaseScreen
	{
        ...
        public void txt_QuickUsername_SendKeys(string Input)
        {
            Point Username = new Point(855, 493);

            Mouse.Instance.Location = Username;
            Mouse.LeftDown();
            Mouse.LeftUp();
            Thread.Sleep(1000);
            Keyboard.Instance.HoldKey(KeyboardInput.SpecialKeys.CONTROL);
        ...
        public void txt_QuickPassword_SendKeys(string Input)
        {
            Point Password = new Point(855, 517);

            Mouse.Instance.Location = Password;
            Mouse.LeftDown();
            Mouse.LeftUp();
            Thread.Sleep(1000);
            Keyboard.Instance.Enter(Input);
        ...
        public void btn_QuickLogOn_Click()
        {
            Point LogOn = new Point(820, 603);

            Mouse.Instance.Location = LogOn;
            Mouse.LeftDown();
            Mouse.LeftUp();
            Thread.Sleep(1000);
