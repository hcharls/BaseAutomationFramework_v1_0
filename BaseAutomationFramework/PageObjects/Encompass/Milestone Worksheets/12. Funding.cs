...
{
	public class Funding : BaseScreen
	{
		...
		public static Funding Initialize()
		{
			return new Funding();
		}
		...
		public Funding chk_Finish_Check()
		{
		...
		private PropertyCondition btn_Shipper = new PropertyCondition(AutomationElement.AutomationIdProperty, "pictureBoxNextLA");
		//
		public Funding btn_Shipper_Click()
		{
			aElement = aeScreen.FindFirst(TreeScope.Descendants, btn_Shipper);
